...
public class Scope {
    ...
    private Map<String, SuperBizonchikValue> variables;
    ...
    public Scope(Scope p) {
        parent = p;
        variables = new HashMap<String, SuperBizonchikValue>();
    }

    public void assignParam(String var, SuperBizonchikValue value) {
    ...
    private void reAssign(String identifier, SuperBizonchikValue value) {
    ...
    public SuperBizonchikValue resolve(String var) {
        SuperBizonchikValue value = variables.get(var);
        if(value != null) {
    ...
    public String toString() {
        ...
        for(Map.Entry<String,SuperBizonchikValue> var: variables.entrySet()) {
